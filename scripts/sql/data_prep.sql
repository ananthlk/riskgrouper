...
WITH daily_agg AS (
    ...
    SELECT
        ...
        AVG(NOTE_HEALTH_DELTA_MKT) AS NOTE_HEALTH_DELTA_MKT,
        AVG(NOTE_RISK_HARM_DELTA_MKT) AS NOTE_RISK_HARM_DELTA_MKT,
        AVG(NOTE_SOCIAL_DELTA_MKT) AS NOTE_SOCIAL_DELTA_MKT,
        AVG(NOTE_MEDADH_DELTA_MKT) AS NOTE_MEDADH_DELTA_MKT,
        AVG(NOTE_CAREENG_DELTA_MKT) AS NOTE_CAREENG_DELTA_MKT,
        AVG(NOTE_PROGTRUST_DELTA_MKT) AS NOTE_PROGTRUST_DELTA_MKT,
        AVG(NOTE_SELF_DELTA_MKT) AS NOTE_SELF_DELTA_MKT,
...
SELECT
    ...
    p.NOTE_SELF_SCORE,
    p.NOTE_HEALTH_DELTA_MKT,
    p.NOTE_RISK_HARM_DELTA_MKT,
    p.NOTE_SOCIAL_DELTA_MKT,
    p.NOTE_MEDADH_DELTA_MKT,
    p.NOTE_CAREENG_DELTA_MKT,
    p.NOTE_PROGTRUST_DELTA_MKT,
    p.NOTE_SELF_DELTA_MKT,
